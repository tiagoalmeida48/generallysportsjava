					...
					<div class="col s4">
						...
						<div class="input-field col s12">
							<label for="inputPassword">Senha</label> <input
								...
								class="validate" required="true" autofocus>
						</div>

						<div class="input-field col s12">
							<a class="btn botao" href="${s:mvcUrl('esqueciSenha').build() }">Esqueci
								minha senha</a> <input type="submit" value="Enviar"
								class="left btn botao">
						</div>
