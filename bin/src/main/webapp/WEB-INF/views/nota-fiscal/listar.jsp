		...
		<div class="row center">
			...
			<div class="row center">
				<f:form method="GET" modelAttribute="notaFiltroForm"
					...
					<div style="display: none;" id="filtro-dtre">
						<div class="input-field col s4">
							<label class="active" for="dataRecebInicial">Data
								Recebimento (Inicial)</label>
							<f:input path="dataRecebInicial" cssClass="validate datepicker" />
						</div>
						<div class="input-field col s4">
							<label class="active" for="dataRecebFinal">Data
								Recebimento (Final)</label>
			...
			<div class="input-field left">
				<a class="waves-effect waves-light btn green white-text"
					title="novo" href="${s:mvcUrl('novoRecebimento').build() }"><i
					class="material-icons left">add</i>Novo Recebimento</a>
			</div>
							...
							<c:forEach items="${listaPaginada.content}" var="notaFiscal">
								...
								<tr>
									...
									<td class="center-align"><a
										...
										href="${s:mvcUrl('visualizarNotaFiscal').arg(0, notaFiscal.idNotaFiscal).build() }"
										title="Visualizar"><i
