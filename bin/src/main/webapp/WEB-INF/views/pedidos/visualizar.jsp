	...
	<div class="container">
		...
		<div class="row">
			...
			<c:forEach items="pedidoCompraForm">
				<fmt:parseDate value="${pedidoCompraForm.pedidoCompra.dtPedido }"
					pattern="yyyy-MM-dd" type="date" var="parsedDtPedido" />
				<fmt:parseDate value="${pedidoCompraForm.pedidoCompra.dtEntrega }"
					pattern="yyyy-MM-dd" type="date" var="parsedDtEntrega" />
								...
								<table class="striped">
									<tbody>
										...
										<tr>
											...
											<td><fmt:formatDate value="${parsedDtPedido }"
													pattern="dd/MM/yyyy" /></td>
										</tr>
										<tr>
											<td>Data de Entrega:</td>
											<td><fmt:formatDate value="${parsedDtEntrega }"
													pattern="dd/MM/yyyy" /></td>
										</tr>
										<tr>
