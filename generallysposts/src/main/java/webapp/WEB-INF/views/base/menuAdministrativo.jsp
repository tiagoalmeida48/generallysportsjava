					...
					<sec:authorize access="isAuthenticated()">
						<nav>
							<div class="nav-wrapper blue darken-4">
								...
								<ul class='right hide-on-med-and-down'>
									<li><a href="${s:mvcUrl('paginaPainel').build() }">Acessar Painel</a></li>
									<li><a href="${s:mvcUrl('listarFornecedores').build() }">Fornecedores</a></li>
									<li><a href="${s:mvcUrl('listarProdutos').build() }">Produtos</a></li>
									<li><a href="${s:mvcUrl('listarPedidos').build() }">Pedido de Compra</a></li>
									<li><a href="${s:mvcUrl('listarNotasFiscais').build() }">Notas Fiscais</a></li>
									<li>
										<sec:authentication property="principal" var="user" />
										<a class="dropdown-trigger" href="#!" data-target="submenuusuarios">
										<c:if test="${user.caminhoFoto == null || user.caminhoFoto == ''}">
											<img class="avatarMenu" src="/img/default_avatar.png" alt="Avatar do Usuário">
										</c:if>
										<c:if test="${user.caminhoFoto != null && user.caminhoFoto != ''}">
											<img class="avatarMenu" src="/img/${user.caminhoFoto}" alt="Avatar do Usuário">
										</c:if>
										<span><b style="text-transform: uppercase;">
						...
						<ul id="mobile-demo" class="sidenav">
							<li>
								...
								<span><b style="text-transform: uppercase;"><sec:authentication property="principal.login" /></b>
							</li>
							<li><a href="${s:mvcUrl('paginaPainel').build() }">Acessar Painel</a></li>
							<li><a href="${s:mvcUrl('listarFornecedores').build() }">Fornecedores</a></li>
							<li><a href="${s:mvcUrl('listarProdutos').build() }">Produtos</a></li>
